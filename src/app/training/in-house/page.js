    ...
    <div className="relative overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <p className="text-xl max-w-2xl mx-auto">
              Custom-designed training programs delivered exclusively for your
              organization, aligned with your business objectives and culture.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Our training consultants are here to help you design the perfect
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-8 max-w-2xl mx-auto">
            Schedule a consultation with our training experts to discuss your
            organization's needs and discover how our customized in-house
            training programs can help achieve your goals.
          </p>
